...
- Borrower Redemption Fee: 0.25% (applied whenever earmarked debt is settled, whether through a Transmuter redemption, a force-repay during liquidation or self-liquidation, or your own MYT repayment of an earmarked amount).

- MYT Yield Fee: 15.00% (a performance fee on gross yield generated by strategies).

- Early Transmutation Fee: 1.00% on Ethereum and Optimism, 2.50% on Arbitrum (applied if you withdraw assets from the Transmuter queue before maturity; set per chain).
