...
Users can mitigate liquidation risk by using a conservative LTV based on the risk levels of the strategies that make up each MYT. The High and Medium risk strategies in each MYT are limited to 10% and 40% of the MYT, respectively. If the liquidation LTV is 95% then the user can take a 45% LTV. In this scenario, even if all of the High and Medium risk strategies suffer 100% losses, the user will still have a 90% LTV and therefore not be subject to liquidation.
