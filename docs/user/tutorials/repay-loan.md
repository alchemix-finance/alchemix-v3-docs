...
Your loan cost falls from 27 USDC to about 18.45 USDC. The remaining 100 USDC of collateral, plus any yield it has earned, stays in the vault for you to withdraw.

If alUSD trades at a deeper discount when you repay than when you sold, the recovery is larger than the original cost and you come out ahead.
