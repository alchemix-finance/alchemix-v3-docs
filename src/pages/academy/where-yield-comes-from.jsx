...
export default function WhereYieldComesFromLesson() {
  return (
    <LessonPage
      ...
      description="Where your collateral earns while a loan runs, and the ceilings the DAO puts on how much risk the vault may hold."
      Lab={MixLab}
      Wrap={Wrap}
      deeper={[
        { to: "/user/concepts/myt-and-yield", label: "Mix-Yield Token" },
        { to: "/governance/guides/myt-strategies", label: "MYT Launch Strategies", note: "the classification rules and the cap table" },
