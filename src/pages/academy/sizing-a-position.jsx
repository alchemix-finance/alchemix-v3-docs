...
export default function Lesson() {
  return (
    <LessonPage
      lessonId="capstone"
      description="The price you can sell at determines what you borrow, and the loss you want to survive determines how much collateral it needs. One deposit has to satisfy both."
      Lab={Lab}
      Wrap={Wrap}
      deeper={[
