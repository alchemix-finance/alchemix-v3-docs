...
export const BEGINNER = [
  {
    ...
    blurb: "An Alchemix loan charges no interest, and the balance falls while you do nothing.",
    minutes: 5,
    ready: true,
    track: "beginner",
  },
  {
    ...
    title: "Your deposit",
    blurb: "Your deposit earns in a vault the DAO steers. Nothing locks it in.",
    minutes: 6,
    ready: true,
    track: "beginner",
  },
  ...
  },
  {
    ...
    blurb: "Left alone, the balance only falls. Your own choices are the only things that move it.",
    minutes: 7,
    ready: true,
    track: "beginner",
  },
  {
    ...
    blurb: "A price crash cannot touch your position. A loss inside the vault is the one thing that can.",
    minutes: 7,
    ready: true,
    track: "beginner",
  },
...
export const INTERMEDIATE = [
  ...
  },
  {
    ...
    blurb: "Borrowing more does not make a loan take longer to clear. The protocol sets the pace for everyone.",
    minutes: 8,
    ready: true,
    track: "intermediate",
  },
  ...
  },
  {
    ...
    blurb: "An Alchemix loan has no interest rate, so the cost arrives somewhere else. Work out where.",
    minutes: 8,
    ready: true,
    track: "intermediate",
  },
