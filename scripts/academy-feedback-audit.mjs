...
const CHECKS = [
  ...
  ["current Aggressive cap", "present", "At most 20% of the vault"],
  ["current Moderate cap, stated as cumulative", "present", "At most 60% of the vault, and no single Moderate strategy above 40%"],
  ...
  ["a stage change scrolls to the top", "present", "window.scrollTo(0, 0);\n  }, [stage]);"],
  ["the last lesson's way back is a button", "present", '<Link to="/academy" className={styles.wrapNext}>'],
  ["headings one weight lighter", "gone", "line-height: 1.14;\n  font-weight: 800;"],
  ["lesson 4 asks about one year", "present", "One year at {RATE}, and you never touch it."],
  ["lesson 4 no longer asks about two years", "gone", "Two years at {RATE}"],
