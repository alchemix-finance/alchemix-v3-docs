# Academy copy deck · Beginner track

Every sentence a learner sees, in the order they meet it. Edit the text in this
document, hand it back, and the edits are carried into the site exactly as
written, on both the pages and the grading server.

## How to edit this document

- Edit any text freely. Leave the numbered tags (like `3.07 · Note`) alone; they
  are how each edit finds its way back to the right place.
- Anything in {curly braces} is a number the app fills in live, because every
  learner gets different figures. You can move a placeholder within its
  sentence, but do not delete one or invent a new one.
- In the Check sections, the option marked ✓ is the correct answer. The app
  shuffles the order for every learner, so the position here does not matter,
  but each question must keep exactly four options, and the ✓ must stay on the
  same idea. The indented line under each option is the feedback shown to a
  learner who picks it.
- To cut a block, replace its text with [CUT]. To add something, write it where
  it belongs and start the line with NEW:.
- House rule carried over from the docs: no em dashes. Any that slip in will be
  rewritten with a comma or a period on the way back into the site.
- Two facts are deliberately never stated as numbers anywhere in the track: the
  live yield rate and the Transmuter term length. Both move, so the lessons make
  them sliders and point at the app. Please keep it that way.

---

## The story, in one page

The track makes one argument in seven steps: you can use the value of your money
without giving the money up, and the system that makes that true is safe to
touch. Each lesson runs Learn (a scenario and a guess), Try (a control panel to
push), then Check (one graded question). This is the spine to walk when you
review the flow.

**Landing page** · Promise: learn by doing. Seven short lessons, no wallet,
nothing to install, no experience assumed.

**1 · What Alchemix does** · The learner opens three product pillars, then plots
a normal loan against an Alchemix loan. Claim: the balance falls on its own, no
interest, no schedule. Leaves believing: this is not the loan I know, and the
difference is the product.

**2 · Your deposit and what it earns** · Guesses next-day availability, then
grows a deposit on a chart. Claim: deposits become MYT, the DAO steers the
strategies, there is no lock-up. Leaves believing: I know where my money is, and
I can leave whenever I want.

**3 · Borrowing against your deposit** · Guesses the borrowing cap, then pushes
a position up to it. Claim: borrow up to 90%, you receive freshly minted alUSD,
the deposit keeps earning, and the swap gap is the real cost. Leaves believing:
I know what I get, what it costs, and that hitting the cap is harmless.

**4 · The loan repays itself** · Guesses a balance after two untouched years,
then applies four events and watches which ones move it. Claim: only your own
choices move the balance; price and time do not. Leaves believing: I can leave
it alone and trust the direction.

**5 · Getting your money back** · Guesses the withdrawable amount, then repays
and watches collateral unlock. Claim: the 90% rule read backwards; every unit
repaid frees more than a unit. Leaves believing: I can get out, and the smaller
number will not surprise me.

**6 · What can go wrong** · Predicts the outcome of a 40% crash for two
borrowers, then drags a price control that does nothing and a vault-loss control
that does. Claim: price cannot liquidate, a loss inside the vault can, and the
cap and the threshold are different lines. Leaves believing: I know the one real
risk and how to size against it.

**7 · The Transmuter** · Guesses the redemption amount, then compares selling
now against waiting for par. Claim: 1:1 after a governance-set term, an early
exit costs a fee, capacity is per chain, and the guarantee is what holds the
peg. Leaves believing: I can close the loop, and the two halves are one system.

**Graduation** · The track map flips to complete, points show as banked, and the
learner is pointed at the quick start and the live app.

Two questions worth asking at each stop as you walk it:

1. Could a learner say the "leaves believing" line in their own words at that
   point? If not, the lesson taught the wrong sentence.
2. Does the lesson use a word the track has not yet earned? The order introduces
   each term before it is leaned on: MYT in lesson 2, LTV in 3, earmarked in 5,
   like-kind in 6.
...
These lines appear in every lesson. One edit here changes them everywhere.

**C.01 · Stage names** (the stepper at the top of every lesson)

Learn · Try · Check

**C.02 · Wrap-up heading** (shown once a lesson is passed)

What you just worked out

**C.03 · Reading list label**

Go deeper in the docs

**C.04 · While a graded question loads**

Preparing your question...

**C.05 · If the grading server cannot be reached**

Headline: The checkpoint is not answering.

Body: Everything you worked out in this lesson still stands. Only the graded
question needs the server, so try again in a moment.

Button: Try again

(The multiple-choice version says "worked through" instead of "worked out".)

**C.06 · Anti-sharing note on number questions**

Every learner is given different figures, so an answer shared with you will not
fit your version of the question.

**C.07 · Anti-sharing note on multiple-choice questions**

The options are ordered differently for every learner, so an answer shared with
you will not match your version.

**C.08 · After a wrong number answer**

Your answer was {x}. This question wanted {y}, accepted within {z}. The next
question uses fresh figures, so the number above will not fit it.

Button: Try a new question

**C.09 · Buttons used throughout**

Check my answer · Submit answer · Checking... · Back to the track

**C.10 · Nudge before an option is picked**

Pick an option to answer.

---

## Landing page (the track map)
...
**0.04 · Markets strip** (three chains, each labelled "alETH · alUSD")

Six markets on three chains: an ETH and a USDC market on each. Everything in
these lessons applies to all six.

**0.05 · Lesson row chrome**

Lesson {n} · Up next, with the button "Start lesson" and the note "About {n} minutes"

Lesson {n} · Complete, with the link "Revisit lesson"

**0.06 · Advanced track teaser**

Eyebrow: Advanced track

Body: Coming after this one, for anyone who wants the arithmetic underneath.
...
The six advanced lessons listed under it (titles and blurbs; the lessons
themselves get their own deck after their walkthrough):
...
**0.07 · Reward card, role**

Label: On finishing the track

Title: The graduate role, and a place in the founding class

Body: Each track has its own Discord role. The founding class role is available
only before season one opens. Once the season begins it can no longer be earned.

**0.08 · Reward card, points**

Label: Banked for season one

Figure: {points} of {total} points

Body: Each lesson banks {100} points, and finishing the track banks {200} more.
Everything converts to season points when season one opens, so graduates begin
the season with a balance already banked.

**0.09 · Completion box** (appears once all seven are passed)

Label: Track complete

Title: Every lesson passed.

Body: The next step is the real thing. The quick start walks the same flow in
the interface, with real numbers and screenshots, and the app itself is at
alchemix.fi.

**0.10 · Link preview description** (search results and shared links)

Learn how Alchemix works by using it. Seven short lessons, no wallet, no
sign-in, and no prior experience assumed.
...
**1.02 · Link preview description**

The three things Alchemix does, and why its loans behave differently from every
other loan you have taken.

### Stage 1 · Learn

**1.03 · Opening**

Headline: Alchemix does three things.
...
Body: Your deposit goes into a vault that spreads it across several yield
strategies. The Alchemix DAO, the community that governs the protocol, picks
those strategies and adjusts them over time, so there is nothing for you to
manage. There is no lock-up, and you can take your money out whenever you want.

**1.05 · Card, Borrow**

Line: Take a loan against that deposit, up to 90% of its value.

Body: You keep the deposit and it keeps earning. The loan charges no interest
and has no payment schedule, and the balance goes down over time on its own.
Most people find this surprising, and the next few lessons show how it works.

**1.06 · Card, Earn a fixed return**

Line: Buy alUSD or alETH below face value and redeem it at full value later.

Body: Alchemix loans are issued as alUSD and alETH. Anyone can hand those back
to the protocol and receive the real asset at an exact 1:1 rate, once a set
waiting period is up. Buying below 1.00 and waiting is a return you can work out
in advance. Lesson 7 covers it.

**1.07 · Nudge until all three are opened**
...
Headline: The same loan, two ways.

Both lines start at $10,000 borrowed. Set a rate you might be charged elsewhere,
and how long you want to look ahead.

**1.10 · Chart furniture**

Chart label: What you still owe

Legend: A normal loan · An Alchemix loan

Sliders: Rate on a normal loan · Looking ahead

**1.11 · Tile, Normal loan**
...
Move either control to carry on.
...
### Stage 3 · Check (one of these three, chosen at random)

**1.15 · Headline**

One question before you move on.

**1.16 · Question 1 (graded)**

Q: You borrow against a deposit in Alchemix and then leave it alone. What
happens to the amount you owe?
...
**1.17 · Question 2 (graded)**

Q: What are you charged for an Alchemix loan?
...
**1.18 · Question 3 (graded)**

Q: What happens to your deposit while a loan is open against it?
...
Subheading: Why the balance falls
...
Quick Start, open a position in a few minutes · Self-Repaying Loans · Glossary,
...
**2.02 · Link preview description**

What your deposit turns into, who decides where it earns, and how quickly you
can take it back.
...
**2.04 · Flow diagram** (three steps)

1 · You deposit · $10,000 USDC · Your own money

2 · The vault gives you · MYT · A share of the whole pot

3 · The MYT earns · Continuously · From the moment it is minted

**2.05 · Note, Who chooses**
...
Slider: Available the next day (scale: Nothing → All $10,000)

Aside next to the button: This one is not a trick.
...
**2.11 · Chart furniture**

Chart label: Value of your deposit

Tiles: Deposited · After one year · After 5 years · Earned

Sliders: Deposit · Suppose it earns ({rate}% a year)

**2.12 · Nudge**

Move both controls to carry on.
...
### Stage 3 · Check (a number to work out; figures are fresh per learner)

**2.14 · The graded question**

Headline: Work out what the deposit is worth.

Q: You deposit {amount} USDC. Suppose the vault earns {rate}% over the next
year. What is your deposit worth at the end of it?
...
Subheading: How the earning reaches you
...
Mix-Yield Token, what your deposit becomes · Use Passive MYT
...
**3.02 · Link preview description**

How much you can borrow against a deposit, what arrives when you do, and what
...
Headline: How much can you borrow?
...
Slider: Most you can borrow (scale: Nothing → All $10,000)

Aside: Most lending protocols allow far less than this one.

**3.05 · Reveal**

Title: Up to $9,000, which is 90% of what you deposited.
...
Headline: Push it to the limit and see what stops you.

Move the deposit and the amount borrowed. Watch the bar, and try taking the
borrow as high as it will go.

**3.07 · Meter and tiles**

Meter label: Loan to value · Borrowing stops at 90%

Tiles: Deposited · Borrowed · Could still borrow · Still earning

Sliders: Deposit · Borrow (at the cap it reads: the cap stops you here)

**3.08 · Note, Still earning**
...
Move both controls, and take the borrow up to the cap.
...
**3.12 · The graded question**

Headline: Find the most you could borrow.

Q: Your position holds {amount} of collateral and you have not borrowed anything
yet. What is the most you can borrow against it?
...
Subheading: Your deposit stays yours
...
Take a Loan · alAssets, what borrowing mints · Self-Repaying Loans
...
**4.02 · Link preview description**

Watch a loan balance fall on its own, and find out which of four events moves
it.
...
Headline: You borrow, then you do nothing.
...
Slider: Still owed after two years (scale: Nothing → More than you borrowed)

Aside: Nothing was repaid by hand, and no interest was charged.

**4.05 · Chart label** (appears with the answer)

What you owe, doing nothing
...
Wait six months · No effect beyond the fall already happening. Nothing is added
for time passing.

Also on this screen: a "Start over" link, the limit note "That is four changes.
Start over if you want to try the others.", and the nudge "Try at least three of
them to carry on."
...
Note, Price moves: Your debt is recorded in alUSD or alETH, the same kind of
asset you deposited. When the price moves, both sides move together, so what you
owe relative to what you hold does not change.

Note, Time: No interest is added for time passing. Time only ever brings the
balance down.
...
**4.11 · Question 1 (graded)**

Q: Starting from an open loan you leave alone, which of these makes the amount
you owe go up?
...
**4.12 · Question 2 (graded)**

Q: You want your loan cleared sooner than the protocol will clear it on its own.
What can you do?
...
**4.13 · Question 3 (graded)**

Q: You open a loan and do not touch it for a year. Which description fits what
...
Subheading: What does not change it
...
Self-Repaying Loans · Redemption Rate, what sets the pace · Repay a Loan
...
**5.02 · Link preview description**

Two ways to get your deposit back, and why the amount you can withdraw is
...
Headline: You want some of your deposit back.
...
Slider: Withdrawable now (scale: Nothing → All $10,000)

Aside: Your borrowed alUSD stays borrowed either way.

**5.05 · Reveal**

Title: $4,444 is free to move.
...
Headline: Two ways out, and one unlocks the other.
...
**5.07 · Meter and tiles**

Meter: Your $10,000 deposit · {amount} free

Under the bar: {amount} held against the loan · {amount} yours to move

Tiles: Still owed · LTV · Can withdraw · Must leave

Slider: Repay by hand (when the loan clears it reads: loan cleared, everything
is free)
...
Move the repay control to carry on.
...
**5.13 · The graded question**

Headline: Work out the withdrawal.

Q: A position holds {amount} of collateral against {amount} of debt. How much of
that collateral can you withdraw right now, without repaying anything first?
...
Subheading: Why the free amount is smaller than you expect
...
Subheading: Two details the app will show you
...
**6.02 · Link preview description**

Why a price crash cannot liquidate an Alchemix position, and what can.

### Stage 1 · Learn

**6.03 · Opening**

Headline: A very bad day for the price.
...
Ana · Deposited $10,000 · Borrowed $4,500 · LTV 45%

Ben · Deposited $10,000 · Borrowed $8,500 · LTV 85%

**6.05 · Prediction question** (ungraded, a warm-up)

What happens to the two positions?
- Both are liquidated
- Ben is liquidated, Ana is fine
- Neither is liquidated
- Both are partly sold to bring their ratios down

Aside: Guessing is free here. The graded question comes at the end.
...
Headline: One of these controls does nothing.

Set a starting LTV, then try both. The bar shows where the position sits against
the 95% threshold that would close it.

**6.08 · Meter and sliders**

Meter: Loan to value now · Cap 90% · Liquidation 95%

Sliders: Starting LTV · Price of your collateral (after moving it: no effect on
the bar) · Loss inside the vault (past the line: threshold crossed)

**6.09 · Note, The price control**
...
Try both of the lower controls to carry on.
...
**6.15 · Question 1 (graded)**

Q: Which of these can put an Alchemix position at risk of liquidation?
...
**6.16 · Question 2 (graded)**

Q: Your position reaches the 90% borrowing cap. What happens next?
...
**6.17 · Question 3 (graded)**

Q: Why can a swing in the price of your collateral not liquidate an Alchemix
loan?
...
Subheading: What can trigger a liquidation
...
Subheading: The cap and the threshold are different things
...
Liquidations · Risk Considerations · Mix-Yield Token, where a loss would come
from
...
**7.02 · Link preview description**

Turn alAssets back into the underlying asset at an exact 1:1 rate, once you have
waited out the term.
...
Headline: Turning alUSD back into USDC.
...
**7.05 · Flow diagram** (four steps)

1 · Deposit · alUSD goes in · You hand your alAssets to the Transmuter

2 · Queue · The term runs · Your deposit waits out the governance-set term

3 · Earmark · Collateral is reserved · Borrower collateral equal to your claim
is set aside to guarantee it

4 · Maturity · One for one · You receive full value, whatever the market price
is
...
Slider: USDC received (scale: Less than you put in → More than you put in)

Aside: The market price does not come into this one.

**7.07 · Reveal**

Title: Exactly $5,000. One for one.
...
Headline: Sell now, or wait and get the full amount.
...
Sell on the market · {amount} · USDC, today

Wait for the Transmuter · $5,000 · USDC, in {n} weeks

Readout under them: Waiting is worth {amount} more than selling today, at a
price of {price}. Whether that is worth the wait is your call, and the answer
changes with both controls.

Sliders: Market price of alUSD · Current term

**7.10 · Note, Leaving early**
...
**7.11 · Note, Why it fills over time**
...
The last question in the track.

**7.16 · Question 1 (graded)**

Q: You put 5,000 alUSD into the Transmuter and wait the full term. What do you
get back?
...
**7.17 · Question 2 (graded)**

Q: What decides how long you wait for a Transmuter deposit to mature?
...
**7.18 · Question 3 (graded)**

Q: You need your funds back before your Transmuter deposit has matured. What are
your options?
...
Subheading: Where your redemption comes from
...
The whole loop, in one picture: (the diagram in block 7.21 renders here)

Subheading: Two things to know before using it
...
Subheading: Why alAssets trade below 1.00
...
**7.21 · The system loop diagram** (five stops and a closing caption)

Borrow · alUSD is minted · A borrower mints it against a deposit that keeps
earning.

Sell · usually just under 1.00 · Sold for working capital, which opens the
discount.

Buy · the discount changes hands · A buyer takes the cheap alUSD to the
Transmuter.

Wait · collateral is earmarked · Borrower collateral is reserved for the claim,
and keeps earning until it settles.

Redeem · 1:1 at maturity · The buyer is paid in full, the borrower's debt falls,
and the alUSD is burned.

Caption: The burn shrinks the supply, the price moves back towards 1.00, and the
loop starts again.

**7.22 · Reading list**

Transmuter · Redeem alAssets · How the Peg is Maintained
